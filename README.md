...
## Update Logs
- 23.11.30
    - 💥 🤗 [KoLLaVA-v1.5-Synatra-7b](https://huggingface.co/tabtoyou/KoLLaVA-v1.5-Synatra-7b) 공개 : 🤗 [Synatra-7b-v0.3-dpo](https://huggingface.co/maywell/Synatra-7B-v0.3-dpo)를 [KoLLaVA-Instruct-612k](https://huggingface.co/datasets/tabtoyou/KoLLaVA-Instruct-612k)(공개 예정)으로 Finetune (V100 80G 8개, 약 13시간) / 코드 및 학습방법 공개 예정
- 23.08.05
