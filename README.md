...
<p align="center">
    <a href="https://cocoa-t.tistory.com/entry/%EB%85%BC%EB%AC%B8-%EB%A6%AC%EB%B7%B0-LLaVA-Large-Language-and-Vision-Assistant-Visual-Instruction-Tuning"><img src="images/KoLLaVA_logo.png" width="30%"></a> <br>
    Generated by <a href="(https://wrtn.ai/)">뤼튼</a> via "한라산 배경의 귀여운 흰 진돗개를 단순한 형태의 만화 이미지로 그려줘"
</p>
