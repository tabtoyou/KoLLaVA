...
## Update Logs
- 23.11.30
    - 💥 🤗 [KoLLaVA-v1.5-Synatra-7b](https://huggingface.co/tabtoyou/KoLLaVA-v1.5-Synatra-7b) 공개 : 🤗 [Synatra-7b-v0.3-dpo](https://huggingface.co/maywell/Synatra-7B-v0.3-dpo)를 [KoLLaVA-Instruct-612k](https://huggingface.co/datasets/tabtoyou/KoLLaVA-Instruct-612k)(공개 예정)으로 Full-finetuning (A100 80G 8개, 약 13시)
- 23.08.05
...
- 23.06.12 
    ...
    - 💥 Colab(Pro) 이용한 inference 예시  <a style='display:inline' target="_blank" href="https://colab.research.google.com/github/tabtoyou/KoLLaVA/blob/main/KoLLaVA-v1-Kovicuna-7b_inference.ipynb.ipynb">
...
## Install
아래 과정은 Linux 기준으로 작성되었습니다. macOS에서 테스트 하실 경우 [여기](https://github.com/tabtoyou/KoLLaVA/blob/00059c578be61e4fdf99b8c050de426c1fd36fb8/docs/macOS.md)를 참고하세요.
...
## Inference
터미널 창에서 아래 명령어를 통해 multi-turn 대화가 가능합니다. 또한 M1/M2 칩이 탑재된 Apple 디바이스를 사용하는 경우 `--device` flag를 사용하여 mps 디바이스를 지정할 수 있습니다. (`--device mps`) macOS에서 테스트 하실 경우 [여기](https://github.com/tabtoyou/KoLLaVA/blob/00059c578be61e4fdf99b8c050de426c1fd36fb8/docs/macOS.md)를 참고하세요.
```
